function checkUsername(inputElement, originalValue)  {
...
const checkUsernameAtRegister = (inputElement, originalValue) => {
    inputElement.classList.remove('is-invalid');
    inputElement.classList.remove('is-valid');
...
const checkEmail = (inputElement, originalValue) => {
...
const checkNickname = (inputElement, originalValue) => {
    inputElement.classList.remove('is-invalid');
    inputElement.classList.remove('is-valid');
    inputElement.value = inputElement.value.replace(/\s/gi, "");
...
const updateSubmitCheck = (formElement) => {
    ...
    if(formElement['password'].value === "" || formElement['passwordRe'].value === "") {
        if(!checkPassword(formElement['password'])) {
            return false;
        }

        if(!checkPasswordRe(formElement['passwordRe'])) {
            return false;
        }
    }
