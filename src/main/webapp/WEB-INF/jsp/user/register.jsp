...
<div class="container">
    ...
    <div class="container">
        <form:form class="needs-validation">
            ...
            <div class="mb-3">
                <div class="form-label-group position-relative">
                    <input type="email" class="form-control" name="email" id="inputEmail" maxlength="320"
                           placeholder="이메일"
            ...
            <div class="mb-3">
                <div class="form-label-group position-relative">
                    <input type="password" class="form-control" name="passwordRe"
                           ...
                           onkeyup="checkPasswordRe(this)" required>
            ...
            <hr class="mb-4">
            <div>
                <button class="btn btn-primary btn-lg" onsubmit="return registerSubmitCheck(this)" type="submit">회원 가입
                </button>
