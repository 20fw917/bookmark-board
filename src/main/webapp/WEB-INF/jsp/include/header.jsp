...
<header class="p-3 text-bg-dark" style="margin-bottom: 40px">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a style="margin-right: 13px; font-size: 22px;" href="${pageContext.request.contextPath}/"
               class="d-flex align-items-center mb-2 mb-lg-0  bi bi-journal-bookmark-fill text-white text-decoration-none">
                북마크
            </a>
        ...
        <c:choose>
          ...
          <c:otherwise>
            ...
            <form:form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" method="get"
                       action="${pageContext.request.contextPath}/search">
                <input type="search" name="keyword" class="form-control form-control-dark text-bg-dark" placeholder="검색"
                       aria-label="Search">
            </form:form>
            ...
            <div class="dropdown text-end">
                   ...
                   aria-expanded="false">
                    ...
                    <c:if test="${principal.profileImage ne null && principal.profileImage ne ''}">
                        <img class="rounded-circle"
                             src="${pageContext.request.contextPath}/attachment/${principal.profileImage}" width="32"
                             height="32" alt="">
                    </c:if>
                ...
                <ul class="dropdown-menu text-small">
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/profile/mypage">마이 페이지</a>
                    </li>
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/profile/update">개인정보 수정</a>
                    </li>
                    <li>
