...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/profile/update.js"></script>
    <sec:csrfMetaTags/>
</head>
...
<div class="container">
    ...
    <div class="container">
        <form:form>
            <input type="hidden" name="internalId" value="${toModifyUser.internalId}">
            <input type="hidden" name="profileImage" value="${toModifyUser.profileImage}">
